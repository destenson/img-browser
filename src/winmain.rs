...
//         Graphics::Imaging::*,
//         // Networking::BackgroundIntelligentTransferService::*, // unused
//         System::Com::*,
//         System::LibraryLoader::*, UI::Animation::*,
...
//         let path = if PathFileExistsW(w!("image.png")).is_ok() {
//             w!("image.png")
//         } else {
//             w!("vendor/oculante/res/screenshot_exif.png")
//         };
// 
